...
namespace Preparcial.Vista
{
    public partial class FrmMain : Form
    {
        ...
        //Correción: Modificar el group box de actulizar producto tenia 'eliminar producto' corregido
        //           a 'Actualizar producto' en el designer
        ...
        //Correción: Agregar a 'generalTab' para qeu cualquier usuario acceda a él
        ...
        {
            //Correción: Alinacion de codigo
            Application.Exit();
        }

        //Correción: Agregar que al iniciarse la venta muestre un mesajede bienvenida mas nombre de usuario
