...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        {
            //Correción: Correguir 'contrasenia' por 'contrasena' debido a que en la class Usuario.cs esta escrito así
        ...
        private void BttnUpdatePassword_Click(object sender, EventArgs e)
        {
            ...
            // Correción: Modificar de 'Show' a 'ShowDialog' para que al cerrase poble los controles
            frmPassword.ShowDialog();
            // Correción: Agregar metodo de actualización de datos despues de cambiar la contraseña
            PoblarControlers();
        }
    }
}
